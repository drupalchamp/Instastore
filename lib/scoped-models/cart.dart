...
import 'package:instastore/models/line_item.dart';
import 'package:instastore/models/option_type.dart';
import 'package:instastore/models/option_value.dart';
import 'package:instastore/models/order.dart';
import 'package:instastore/models/payment_methods.dart';
import 'package:instastore/models/product.dart';
import 'package:instastore/models/variant.dart';
import 'package:instastore/models/address.dart';
import 'package:instastore/screens/product_detail.dart';
...
mixin CartModel on Model {
  ...
  void getProductDetail(String slug, BuildContext context,
    ...
    // setLoading(true);
    print(
        "PRODUCT SLUG ------> ${'http://instastore.responsivewebsolution.com/api/$slug?_format=json'}}");
    http.Response response = await http.get('http://instastore.responsivewebsolution.com/api/$slug?_format=json',
        headers: headers);
