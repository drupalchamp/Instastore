...
import 'package:instastore/screens/forget_password.dart';
...
class _AuthenticationState extends State<Authentication>
  ...
  Widget _buildEmailTextField() {
    return Padding(
        ...
        child: TextFormField(
          //initialValue: 'chandan.drupalchamp@gmail.com',
  ...
  void _submitLogin(MainModel model) async {
    ...
    final Map<String, dynamic> authData = {
      'name': _formData['email'],
      'pass': _formData['password'],
    };

    final SharedPreferences prefs = await SharedPreferences.getInstance();

    final http.Response tokenResponse = await http.get(API.SESSION_TOKEN_URL);
    ...
    print("debugPrint ${responseData}");
    String message = 'Something went wrong.';
    bool hasError = true;
    if (responseData.containsKey('current_user')) {
    ...
    if (successInformation['success']) {
      debugPrint("if ${responseData['current_user']['uid']}");
      final SharedPreferences prefs = await SharedPreferences.getInstance();
      prefs.setInt('id', int.parse(responseData['current_user']['uid']));
      prefs.setString('email', _formData['email']);
      prefs.setString('spreeApiKey', token);
      prefs.setString('csrf_token', responseData['csrf_token']);
      prefs.setString('logout_token', responseData['logout_token']);
  ...
  void _submitForm() async {
    ...
    final http.Response response = await http.post(
      'http://instastore.responsivewebsolution.com/user/register?_format=json',
      body: json.encode(authData),
